...
export default function ProductionTargetSetterPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-100 dark:bg-slate-900 px-2 md:px-2 py-2">
      <div className="max-w-8xl mx-4 space-y-2">
        ...
        {/* <header className="space-y-1">
          ...
          <p className="text-xs md:text-sm text-slate-600 dark:text-white ">
            ...
            assigned building, and record hourly production against those
            targets.
          </p>
        </header> */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-start">
          ...
          <div className="w-full h-screen lg:col-span-2">
