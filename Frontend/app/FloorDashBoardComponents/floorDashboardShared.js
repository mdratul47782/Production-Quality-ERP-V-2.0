...
/* Refresh knobs */
export const REFRESH_INTERVAL_TV_MS = 15000;
export const REFRESH_INTERVAL_FULL_MS = 10000;
export const HEADER_REFRESH_MS = 60000;
...
const KPI_TONE_MAP = {
  emerald: {
    // light: soft emerald surface  |  dark: original dark glassy look
    card: "from-emerald-100/80 to-emerald-50/60 border-emerald-300/60 ring-emerald-300/40 text-emerald-800 " +
          "dark:from-emerald-500/15 dark:to-emerald-500/5 dark:border-emerald-400/30 dark:ring-emerald-400/40 dark:text-emerald-100",
    badge: "bg-emerald-500 text-white dark:bg-emerald-500/90 dark:text-emerald-950",
    // value color: dark emerald in light, white in dark
    value: "text-emerald-900 dark:text-white",
  },
  sky: {
    card: "from-sky-100/80 to-sky-50/60 border-sky-300/60 ring-sky-300/40 text-sky-800 " +
          "dark:from-sky-500/15 dark:to-sky-500/5 dark:border-sky-400/30 dark:ring-sky-400/40 dark:text-sky-100",
    badge: "bg-sky-500 text-white dark:bg-sky-400/90 dark:text-sky-950",
    value: "text-sky-900 dark:text-white",
  },
  red: {
    card: "from-red-100/80 to-red-50/60 border-red-300/60 ring-red-300/40 text-red-800 " +
          "dark:from-red-500/15 dark:to-red-500/5 dark:border-red-400/30 dark:ring-red-400/40 dark:text-red-100",
    badge: "bg-red-500 text-white dark:bg-red-500/90 dark:text-red-50",
    value: "text-red-900 dark:text-white",
  },
  amber: {
    card: "from-amber-100/80 to-amber-50/60 border-amber-300/60 ring-amber-300/40 text-amber-800 " +
          "dark:from-amber-500/15 dark:to-amber-500/5 dark:border-amber-400/30 dark:ring-amber-400/40 dark:text-amber-100",
    badge: "bg-amber-500 text-white dark:bg-amber-400/90 dark:text-amber-950",
    value: "text-amber-900 dark:text-white",
  },
  purple: {
    card: "from-purple-100/80 to-purple-50/60 border-purple-300/60 ring-purple-300/40 text-purple-800 " +
          "dark:from-purple-500/15 dark:to-purple-500/5 dark:border-purple-400/30 dark:ring-purple-400/40 dark:text-purple-100",
    badge: "bg-purple-500 text-white dark:bg-purple-400/90 dark:text-purple-950",
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-between gap-2">
        ...
        {/* ✅ value: uses per-tone color in light, white in dark */}
        <div className={`text-right text-lg sm:text-xl font-extrabold tabular-nums tracking-tight leading-none ${toneMap.value}`}>
          {value}
        </div>
      </div>
    </div>
  ...
  return (
    <div
      className={`rounded-xl border
        bg-zinc-100 dark:bg-slate-950/90
        px-2 py-1 flex flex-col justify-center leading-tight
        ${accent || "border-zinc-300 text-zinc-700 dark:border-slate-600 dark:text-slate-100"}`}
    >
      <span className="text-[10px] uppercase tracking-wide text-zinc-400 dark:text-slate-400 leading-none">
        {label}
      </span>
...
export function VarianceBarChart({ data }) {
  ...
  if (safe.length === 0) {
    return (
      <div className="flex h-full items-center justify-center text-[11px] text-zinc-400 dark:text-slate-500">
